...
- 复赛结果提交[2025/08/01]：具体路径信息放在文件夹 `solutions/results0730` ![Grade](https://img.shields.io/badge/Rank-NA/25-green)
  ...
  性能对比：并行多策略子问题分解HGS求解器 v.s. 传统单策略子问题分解HGS求解器

  - **并行多策略子问题分解HGS求解器** 10次运行最好的结果：

  | Instance | Vehicles (Ours) | Distance (Ours) | Duration (Ours) | Time (Ours) | Rank (Ours) |
  | :------: | :-------------: | :-------------: | :-------------: | :---------: | :---------: |
  | rc1_2_1  |       18        |    3790.34      |         |    1800     |     NA        |
  | rc1_2_2  |       18        |    3324.27      |         |    1800     |     NA        |
  | rc1_2_3  |       18        |    3224.63      |         |    1800     |     NA        |
  | rc1_2_4  |       18        |    3015.31      |         |    1800     |     NA        |
  | rc1_2_5  |       19        |    3490.03      |         |    1800     |     NA        |
  | rc1_4_1  |               |          |         |    1800     |     NA        |
  | rc1_4_2  |               |          |         |    1800     |     NA        |
  | rc1_4_3  |               |          |         |    1800     |     NA        |
  | rc1_4_4  |               |          |         |    1800     |     NA        |
